...
namespace IoTSpy.Storage.Migrations
{
    ...
    [Migration("20260527195844_AddTrafficInsights")]
    partial class AddTrafficInsights
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IoTSpy.Core.Models.ApiKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("IoTSpy.Core.Models.CaptureAnnotation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("IoTSpy.Core.Models.CapturedRequest", b =>
                {
                    ...
                    b.Property<Guid?>("PassiveCaptureSessionId")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("PassiveCaptureSessionId");
            ...
            modelBuilder.Entity("IoTSpy.Core.Models.ContentReplacementRule", b =>
                {
                    ...
                    b.Property<int?>("SseInterEventDelayMs")
                        .HasColumnType("INTEGER");

                    b.Property<bool?>("SseLoop")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("IoTSpy.Core.Models.FuzzerJob", b =>
                {
                    ...
                    b.Property<bool>("BypassTlsValidation")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("IoTSpy.Core.Models.InvestigationSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("InvestigationSessions");
                });
            ...
            modelBuilder.Entity("IoTSpy.Core.Models.PassiveCaptureSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("DeviceFilter")
                        .HasMaxLength(500)
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("PassiveCaptureSessions");
                });
            ...
            modelBuilder.Entity("IoTSpy.Core.Models.ProtoSchema", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("IoTSpy.Core.Models.ProxySettings", b =>
                {
                    ...
                    b.Property<string>("CaCommonName")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("CaCountry")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("CaOrganization")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<int>("CaValidityYears")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("IoTSpy.Core.Models.ScanScope", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("IoTSpy.Core.Models.SessionActivity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("IoTSpy.Core.Models.SessionCapture", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("SessionId", "CaptureId")
                        .IsUnique();
            ...
            modelBuilder.Entity("IoTSpy.Core.Models.CaptureAnnotation", b =>
                {
                    b.HasOne("IoTSpy.Core.Models.InvestigationSession", "Session")
            ...
            modelBuilder.Entity("IoTSpy.Core.Models.CapturedRequest", b =>
                {
                    ...
                    b.HasOne("IoTSpy.Core.Models.PassiveCaptureSession", "PassiveCaptureSession")
                        .WithMany()
                        .HasForeignKey("PassiveCaptureSessionId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("Device");

                    b.Navigation("PassiveCaptureSession");
                });
