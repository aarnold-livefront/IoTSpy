...
- **Export everywhere** — See [Phase 23 plan](PHASE-23-EXPORT-EVERYWHERE.md). Capture → streaming asset (`.sse`/`.ndjson`), fuzzer results, scan findings, and ruleset bundle export as portable JSON; enables sharing configurations across environments
